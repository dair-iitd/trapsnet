    ...
    def __init__(self,
        ...
        with tf.variable_scope("policy_eval"):
            self.policy_net = PolicyEstimator(
                ...
                policy_net.num_gcn_hidden, policy_net.num_action_dim,
                policy_net.num_decoder_dim, policy_net.num_outputs_list,
            ...
            for i in range(self.N):
                ...
                for _ in range(num_episodes):
                    ...
                    while not done:
                        ...
                        next_state, reward, done, _ = self.envs[i].step(
                            action + 1)
